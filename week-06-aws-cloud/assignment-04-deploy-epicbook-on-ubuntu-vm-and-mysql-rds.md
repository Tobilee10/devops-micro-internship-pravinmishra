...
![screenshot](./screenshots/ass4-tk1-screen2.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![screenshot](./screenshots/ass4-tk1-screen3.png)
...
![screenshot](./screenshots/ass4-tk3-screen6.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![screenshot](./screenshots/ass4-tk3-screen7.png)
...
![screenshot](./screenshots/ass4-tk4-screen8.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![screenshot](./screenshots/ass4-tk4-screen9.png)

---

#### Screenshot 10 — Output of `mysql --version`

![screenshot](./screenshots/ass4-tk4-screen10.png)
...
![screenshot](./screenshots/ass4-tk5-screen11.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![screenshot](./screenshots/ass4-tk5-screen12.png)
---
...
![screenshot](./screenshots/ass4-tk6-screenshot-13.png)
...
![screenshot](./screenshots/ass4-tk8-screen17.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![screenshot](./screenshots/ass4-tk8-screen18.png)
