...
![screenshot1](./screenshots/ass-1-tk1-screen-1.png)

---

#### Screenshot 2 — Output of `ls -a` showing the `.git` folder

![screenshot2](./screenshots/ass-1-tk1-screen-2.png)
...
The .git folder is a hidden directory that stores all the information Git needs to manage projects, including commit history, branches, and configuration.
...
![screenshot](./screenshots/ass-1-tk2-screen-3.png)
...
![screenshot](./screenshots/ass-1-tk3-screen-4.png)
